...
class GestionEstablecimientos extends Component
{
    ...
    protected function rules(): array
    {
        return [
            ...
            'zona' => 'nullable|in:'.implode(',', array_keys(Establecimiento::ZONAS)),
    ...
    public function updatingFiltroProvincia(): void
    {
        $this->resetPage();
    }
    ...
    public function guardar(): void
    {
        ...
        foreach (['provincia', 'partido_departamento', 'localidad', 'zona', 'latitud', 'longitud',
    ...
    private function limpiarFormulario(): void
    {
        $this->reset([
            ...
            'nombre', 'provincia', 'partido_departamento', 'localidad', 'zona',
            'latitud', 'longitud',
            'superficie_total_ha', 'superficie_agricola_ha', 'superficie_ganadera_ha',
