            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    @php
                        ...
                        ][$compra->actividad ?? 'general'] ?? 'bg-secondary-subtle text-secondary';
                    @endphp
                    <tr>
                        ...
                        <td>
                            <span class="badge rounded-pill {{ $badgeActividad }}">
                                {{ $actividades[$compra->actividad ?? 'general'] ?? $compra->actividad ?? 'General' }}
                            </span>
                        </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-3">
                    <form wire:submit="guardar" id="form-compra">
                        ...
                        {{-- Imputación --}}
                        <h6 class="text-muted text-uppercase fw-bold small mb-3 border-bottom pb-2">Imputación</h6>
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Actividad</label>
                                <select class="form-select @error('actividad') is-invalid @enderror"
